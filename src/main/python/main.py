...
def get_layout():
    layout_html = open('../../../layout.html','r')
...
def process_simple(content_folder, template_name):
    ...
    """
    template_html = open(f'../../../{template_name}.html', 'r').read()
    content_md = open(f'../../../content/{content_folder}/index.md', 'r').read()
    layout_html = get_layout()
    ...
    f_out = open(f'../../../public/{content_folder}/index.html', 'w')
